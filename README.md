...
- Go on your Slack App ( [App Slack](api.slack.com/apps) )-> select your app or create new -> Settings -> Install App -> (regenerate two tokens) -> Copy Tokens in `actions/Constants.py` and `credentials.yml` files.
# RASA - LOCAL MODE
